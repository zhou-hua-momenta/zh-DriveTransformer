...
eval_cfg = {
            ...
            "class_range":{'car':(15,30),'van':(15,30),'truck':(15,30),'bicycle':(15,30),'traffic_sign':(15,30),'traffic_cone':(15,30),'traffic_light':(15,30),'pedestrian':(15,30)}
            }
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        ## Major Layer
        transformer=dict(
            type='WrapperAroundMixUpDecoder',
            embed_dims=_dim_,
            decoder=dict(
                type='MixUpDecoder',
                num_layers=12,
                ...
                transformerlayers=dict(
                    ...
                    operation_order=('self_attn', 'norm', 'temp_attn', 'norm', 'cross_attn', 'norm',  'ffn', 'norm'),
                ),
            ),
        ),
        ## Det Loss
...
dataset_type = "B2D_strp_Dataset"
data_root = "data/bench2drive"
info_root = "data/infos"
map_root = "data/bench2drive/maps"
map_file = "data/infos/b2d_map_infos.pkl"
file_client_args = dict(backend="disk")
ann_file_train=info_root + f"/b2d_infos_v1_train_dtr_meta.pkl"
ann_file_val=info_root + f"/b2d_infos_v1_val_dtr_meta.pkl"
ann_file_test=info_root + f"/b2d_infos_v1_val_dtr_meta.pkl"
file_client_args = dict(backend='disk')
...
train_pipeline = [
    ...
    dict(type='MyCustomObjectRangeFilter', point_cloud_range=point_cloud_range),
    dict(type='MyCustomObjectNameFilter', classes=class_names),
    ...
    dict(type='MyCustomDefaultFormatBundle3D', class_names=class_names, with_ego=True, collect_keys=collect_keys),
    dict(type='MyCustomCollect3D',\
...
evaluation = dict(interval=total_epochs * num_iters_per_epoch, pipeline=test_pipeline, metric='bbox', map_metric='chamfer')
