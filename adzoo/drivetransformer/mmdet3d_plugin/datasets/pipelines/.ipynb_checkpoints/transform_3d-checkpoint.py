...
# from mmcv.core.bbox.structures import (CameraInstance3DBoxes, DepthInstance3DBoxes,
#                                LiDARInstance3DBoxes, box_np_ops)


@PIPELINES.register_module()
class MyCustomObjectRangeFilter(object):
...
@PIPELINES.register_module()
class MyCustomObjectNameFilter(object):
...
@PIPELINES.register_module()
class MyCustomCollect3D(object):
