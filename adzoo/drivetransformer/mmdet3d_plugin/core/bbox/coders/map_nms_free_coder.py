...
class MapNMSFreeCoder(BaseBBoxCoder):
    ...
    def decode_single(self, cls_scores, bbox_preds, pts_preds):
        ...
        final_box_preds = bbox_preds#denormalize_2d_bbox(bbox_preds, self.pc_range) 
        final_pts_preds = pts_preds#denormalize_2d_pts(pts_preds, self.pc_range) #num_q,num_p,2
